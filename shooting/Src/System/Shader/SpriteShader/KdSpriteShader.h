...
public:
	...
	void DrawTex_Color(const KdTexture* tex, const Math::Rectangle& srcRect = { 0,0,0,0 }, const Math::Color& color = Math::Color(1, 1, 1, 1), const Math::Vector2& pivot = { 0.5, 0.5f })
	{
		if (tex == nullptr)return;
